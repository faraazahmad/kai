...
class SubmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create submission" do
    assert_difference("Submission.count") do
      post submissions_url, params: { submission: { link: @submission.link, submission_type_id: @submission.submission_type_id } }
    end
  ...
  test "should update submission" do
    patch submission_url(@submission), params: { submission: { link: @submission.link, submission_type_id: @submission.submission_type_id } }
